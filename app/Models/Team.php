...
class Team extends Model
{
    ...
    {
        return $this->belongsToMany(Round::class, 'rounds_teams')->withPivot(['rate', 'role_rates', 'is_presentation', 'opening_rate', 'probing_rate', 'delivering_rate', 'objection_rate', 'closing_rate', 'product_rate']);

<template>
  <div>
    ...
    <div class="row">
      <team-search @submitSearch="submitSearch" :isEmpty="isEmpty" class="col-md-6 col-sm-12"></team-search>
      <team-paginator :pages="pages" :currentPage="currentPage" :total="total" @fill="fill"
        class="col-md-6 col-sm-12"></team-paginator>
    </div>
    <team-list :teams="teams" :pageLoading="pageLoading" @teamDeleted="teamDeleted"></team-list>
  </div>
</template>

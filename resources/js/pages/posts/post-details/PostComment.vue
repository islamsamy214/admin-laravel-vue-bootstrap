    ...
    <div class="card-footer" v-if="post.comments">
      ...
      >
        ...
        <h6 class="card-title" v-if="comment.client">
          ...
          <div
            class="handle-drop-down d-inline float-right"
            v-if="comment.client.id == user.id"
          >
            <a
              id="handeDropDown"
            ...
            >
              ...
              <button
                ...
                @click="deleteComment(comment.id, comment.client.id)"
              >
                Delete
              </button>
            </div>
  ...
  methods: {
    ...
    deleteComment(id, client_id) {
      ...
      function deleteComment(id) {
        axios
          .delete(`/api/comments/${id}`, { data: { client_id: client_id } })
          .then((response) => {
